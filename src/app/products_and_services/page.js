        ...
        <Layout>
            ...
            <div className="w-full">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
                    <div className="bg-[#F7F7F8] rounded-md shadow p-4">
                        <h3 className="font-bold text-gray-700 mb-2">Total de Produtos</h3>
                        <ul className="text-sm">
                            <li><span className="text-yellow-500">●</span><span className="text-black"> Armações:  {totalArmacoes}</span></li>
                            <li><span className="text-blue-500">●</span><span className="text-black"> Lentes: {totalLentes}</span></li>
                            <li><span className="text-orange-500">●</span><span className="text-black"> Óculos de Sol: {totalOculosDeSol}</span></li>
                        </ul>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-4 md:grid-cols-4 mb-20">
                    {productsItems.map((item, index) => (
                        <Link key={index} href={item.route}>
                          <motion.div
                className="relative flex justify-center items-center bg-gradient-to-r from-[#932A83] to-[#B7328C] text-white w-full h-[100px] rounded-xl transition-transform transform hover:scale-110 hover:shadow-2xl hover:brightness-110 cursor-pointer px-8 overflow-hidden"
                style={{
