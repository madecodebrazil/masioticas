    ...
    <div className="flex space-x-4">
        {['Loja 1', 'Loja 2'].map((loja) => (
            <button
                ...
                className={`py-2 px-4 border-2 rounded-lg font-bold transition-all duration-300 whitespace-nowrap ${
                    selectedLojas.includes(loja)
                        ? 'border-[#800080] text-white bg-[#754099]'
                        : 'border-[#800080] text-black hover:bg-[#932A83] hover:text-white'
                }`}
            >
                {loja.toUpperCase()}
            </button>
