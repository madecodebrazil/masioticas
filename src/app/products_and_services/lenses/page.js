    ...
    <Layout>
      <div className="p-4 sm:p-6">
        ...
        <div className="flex justify-end mb-4">
          <button
            className="bg-[#81059e] text-white py-2 px-4 rounded-lg"
            onClick={() =>
                    ...
                    <tr key={lente.produto} className="border-t border-gray-300">
                      ...
                      <td className="p-2 sm:p-4 text-black">
                        <button
                          ...
                          className="text-[#81059e] underline"
                        >
                          {lente.produto}
                        </button>
                      </td>
            ...
            <div className="bg-white p-4 md:p-6 rounded-lg shadow-lg max-w-full sm:max-w-md md:max-w-lg lg:max-w-2xl w-full mx-2 overflow-y-auto max-h-full">
              {editMode ? (
                <div className="space-y-6">
                  <h2 className="text-lg font-bold text-[#81059e] mb-4">
                    Editar Lente
                  </h2>
                  {/* Informações Básicas */}
                  <div>
                    <label className="block font-bold text-[#81059e] mb-1">Produto</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block font-bold text-[#81059e] mb-1">Valor (R$)</label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label className="block font-bold text-[#81059e] mb-1">Fabricante</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block font-bold text-[#81059e] mb-1">Tipo (separar por vírgulas)</label>
                    <input
                      type="text"
                      value={
                  ...
                  <div>
                    <label className="block font-bold text-[#81059e] mb-1">Marca</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block font-bold text-[#81059e] mb-1">Material</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block font-bold text-[#81059e] mb-1">Índice</label>
                    <input
                      type="text"
                  ...
                  <div className="flex space-x-2">
                    <div className="flex-1">
                      <label className="block font-bold text-[#81059e] mb-1">Data</label>
                      <input
                        type="date"
                    ...
                    <div className="flex-1">
                      <label className="block font-bold text-[#81059e] mb-1">Hora</label>
                      <input
                        type="time"
                  ...
                  <div>
                    <label className="block font-bold text-[#81059e] mb-2">Tratamentos</label>
                  ...
                  <div>
                    <label className="block font-bold text-[#81059e] mb-2">Recursos</label>
                    <div className="flex flex-wrap gap-2">
                  ...
                  {/* Imagem */}
                  <div>
                    <label className="block font-bold text-[#81059e] mb-1">Imagem</label>
                    <input
                      type="file"
