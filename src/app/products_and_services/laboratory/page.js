...
const RegisterProvider = () => {
  ...
  return (
    <Layout>
      <div className="p-4">
        <h1 className="text-2xl font-bold text-center text-[#932A83] mb-4">CRIAR LABORATÓRIO</h1>

        <form className="space-y-4" onSubmit={handleSubmit}>
          <div>
            <label className="block text-[#932A83]">CNPJ</label>
            <input 
              type="text" 
              value={cnpj} 
          ...
          <div>
            <label className="block text-[#932A83]">Razão Social</label>
            <input 
              type="text" 
          ...
          <div>
            <label className="block text-[#932A83]">Nome Fantasia</label>
            <input 
              type="text" 
          ...
          <h2 className="mt-4 text-lg font-semibold text-[#932A83]">Endereço</h2>
          <div>
