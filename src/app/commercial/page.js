...
,
    ...
    <Link key={index} href={item.route}>
        <motion.div
            className="relative flex justify-center items-center bg-gradient-to-r from-[#932A83] to-[#B7328C] text-white w-full h-[100px] rounded-xl transition-transform transform hover:scale-110 hover:shadow-2xl hover:brightness-110 cursor-pointer px-6 overflow-hidden"
            style={{
        ...
        >
            ...
            <div className="relative z-10 flex flex-row justify-start items-center w-full h-full">
                ...
                <Image
                    ...
                    width={50}
                    height={50}
                    className="object-contain mr-4" // Adicionando margem para espaçamento entre ícone e texto
                />
                {/* Texto à esquerda */}
