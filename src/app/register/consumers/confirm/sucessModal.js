...
const SucessModal = ({ isOpen, onClose, message, autoClose = true, autoCloseTime = 3000 }) => {
  useEffect(() => {
    if (isOpen && autoClose) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg max-w-md w-full mx-4 shadow-2xl">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-[#81059e] rounded-t-lg">
        ...
        <div className="p-6 text-center">
          <div className="mb-6">
            ...
            <p className="text-gray-500 text-sm">
              O cliente foi adicionado ao sistema e pode ser visualizado na lista de clientes.
            </p>
          </div>
