  ...
  return (
    <div className="flex flex-col p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h1 className="p-2 text-2xl font-semibold text-[#9000ff]">Seus Insights</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-[#fafafa]  rounded-xl border-2 border-gray-200 p-6">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg font-semibold text-gray-700">Desempenho</h2>
            <FontAwesomeIcon icon={faChartLine} className="text-[#84207B] text-xl" />
          </div>
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <span className="text-gray-600">Vendas do Dia</span>
              <span className="font-bold">R$ {performanceData.dailySales.toFixed(2)}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-600">Meta Diária</span>
              <span className="text-green-600">R$ {performanceData.target.toFixed(2)}</span>
            </div>
        ...
        <div className="bg-[#fafafa]  rounded-xl border-2 border-gray-200 p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <FontAwesomeIcon icon={faClipboardCheck} className="text-[#D291BC] text-xl" />
          </div>
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center">
              ...
              <div className="text-2xl font-bold">{serviceOrders.pending}</div>
            ...
            <div className="text-center">
              ...
              <div className="text-2xl font-bold">{serviceOrders.completed}</div>
            ...
            <div className="text-center">
              ...
              <div className="text-2xl font-bold">{serviceOrders.delayed}</div>
        ...
        <div className="bg-[#fafafa]  rounded-xl border-2 border-gray-200 p-6">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg font-semibold text-gray-700">Comissões</h2>
            <FontAwesomeIcon icon={faFileInvoiceDollar} className="text-[#84207B] text-xl" />
          </div>
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <span className="text-gray-600">Comissão Mensal</span>
              <span className="font-bold">R$ {commissions.current}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-600">Projeção</span>
              <span className="text-blue-600">R$ {commissions.projected}</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Agenda do Dia */}
        <div className="bg-[#fafafa]  rounded-xl border-2 border-gray-200 p-6 md:col-span-2">
          <div className="flex justify-between items-center mb-4">
